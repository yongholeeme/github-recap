      ...
      <div className="max-w-6xl w-full">
        ...
        {isFetching ? (
          ...
          <div className="flex flex-col items-center justify-center py-24">
            ...
            >
              <svg className="w-10 h-10" style={{ color: colorScheme.primary }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              return (
                <a
                  ...
                  style={{
                    ...
                    borderColor: isTopThree ? `${colorScheme.accent}40` : `${colorScheme.primary}20`,
                ...
                >
                  ...
                  {/* Rank badge */}
                  <div className="absolute top-4 right-4 w-9 h-9 rounded-xl flex items-center justify-center text-sm font-bold transition-transform group-hover:scale-110"
                    style={{
                  ...
                  <div className="relative mb-4">
                    <div className="flex items-end gap-3">
                      <span className="text-5xl font-black tracking-tighter" style={{ color: colorScheme.accent }}>
                        {repo.count.toLocaleString()}
                      </span>
                      <span className="text-gray-500 text-sm font-semibold uppercase pb-2">{countLabel}</span>
                    </div>
                  </div>
                  ...
                  >
                    <svg className="w-4 h-4" style={{ color: colorScheme.accent }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
